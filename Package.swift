...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "git@github.com:AgoraIO/AgoraLite_iOS", .upToNextMinor(from: "4.5.2")),
    ...
    targets: [
        ...
        url: "https://facephicorp.jfrog.io/artifactory/spm-pro-fphi/SDK/FPHISDKVideoRecordingComponent/2.7.0/videoRecordingComponent.zip",
        checksum: "822e798232133086f822d22476877751fd8ac69b9777371fef7c53ed346ffe51"),
    ]
)
